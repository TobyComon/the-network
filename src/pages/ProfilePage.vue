      ...
      <div v-if="!editing" class="col d-flex mt-2">
        ...
        <div class="text-dark card p-2">
          ...
          <h5 v-if="profile.graduated">
            CodeWorks Graduate! <i class="mdi mdi-school mdi-24px mdi-spin"></i>
          </h5>
    ...
    <div class="text-center">
      ...
      <div class="p-5">
        <h4 class="text-dark">
          ...
          ></i>
          {{ page }} of {{ pages }}
          <i class="mdi mdi-chevron-right selectable" @click="nextPg"></i>
        </h4>
      </div>
    </div>
    <!--  Add next and previous (similar to home page) -->

    <!--  Do I need to make a totalPages and Page in the appstate for the profiles?? -->
    <!-- NOTE Just needed to update those values with the profile posts call -->
  </div>
</template>
